...
class Concert extends Performance {
  ...
  info() {
    // return  `Гурт ${this.band.name} виступить в ${this.location} ${super.date.toLocaleDateString()}, ціна квитка ${this.#ticketPrice}`
  }
 ...
 * | band        | "Led Zeppelin"    |
 */
const guitarist = new Guitarist("Jimmy Page");
/*
 ...
 * | band        | "The Beatles"    |
 */
const bassist = new Bassist("Paul McCartney");
 ...
 * | ticketPrice | 100              |
 */
const concert = new Concert(band, "BBC studios", "1994-07-06", 100);
/*
